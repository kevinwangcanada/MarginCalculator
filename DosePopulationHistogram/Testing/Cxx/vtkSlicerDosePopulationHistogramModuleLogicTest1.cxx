...
int vtkSlicerDoseVolumeHistogramModuleLogicTest1( int argc, char * argv[] )
{
  ...
  vtkSmartPointer<vtkSlicerDosePopulationHistogramModuleLogic> dvhLogic =
    vtkSmartPointer<vtkSlicerDosePopulationHistogramModuleLogic>::New();
  dvhLogic->SetMRMLScene(mrmlScene);

  // Create and set up parameter set MRML node
  vtkSmartPointer<vtkMRMLDosePopulationHistogramNode> paramNode =
    vtkSmartPointer<vtkMRMLDosePopulationHistogramNode>::New();
  ...
  dvhLogic->SetAndObserveDosePopulationHistogramNode(paramNode);
